...
public class UserSuccessDialog extends DialogFragment {
	private static final String TAG = UserSuccessDialog.class.getName();
	...
	public static UserSuccessDialog getInstance(String title, String message) {
		UserSuccessDialog dialog = new UserSuccessDialog();
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.user_success_dialog_fragment, container);
	}
