...
public class UserErrorDialog extends DialogFragment {
	private static final String TAG = UserErrorDialog.class.getName();
	...
	public static UserErrorDialog getInstance(String title, String message) {
		UserErrorDialog dialog = new UserErrorDialog();
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		return inflater.inflate(R.layout.user_error_dialog_fragment, container);
	}
