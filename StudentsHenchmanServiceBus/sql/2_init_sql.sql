...
INSERT INTO	FIELD(NAME,DEPARTMENT_ID) VALUES("Energetyka", (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny"));
#*************************************************************************** 
...
INSERT INTO	FIELD(NAME,DEPARTMENT_ID) VALUES("Transport", (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny"));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I10",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I11",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I12",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I13",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I14",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I15",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I16",1,"Informatyka",1,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1_E.1m",1,"Energetyka",1,(SELECT ID FROM FIELD WHERE NAME = "Energetyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1_E.2m",1,"Energetyka",1,(SELECT ID FROM FIELD WHERE NAME = "Energetyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1_T.1m",1,"Transport",1,(SELECT ID FROM FIELD WHERE NAME = "Transport" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1_T.2m",1,"Transport",1,(SELECT ID FROM FIELD WHERE NAME = "Transport" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("2IB1",2,"Inzynieria biomedyczna",2,(SELECT ID FROM FIELD WHERE NAME = "Inzynieria biomedyczna" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("2IB2",2,"Inzynieria biomedyczna",2,(SELECT ID FROM FIELD WHERE NAME = "Inzynieria biomedyczna" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3I s2",2,"Informatyka",3,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3_E1e",1,"Energetyka",3,(SELECT ID FROM FIELD WHERE NAME = "Energetyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3_E.1m",1,"Energetyka",3,(SELECT ID FROM FIELD WHERE NAME = "Energetyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3_E.1m2",1,"Energetyka",3,(SELECT ID FROM FIELD WHERE NAME = "Energetyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3_T.m",1,"Transport",3,(SELECT ID FROM FIELD WHERE NAME = "Transport" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5M.HLE",1,"Mechatronika - Hybrydowe laczeniowe elementy",5,(SELECT ID FROM FIELD WHERE NAME = "Mechatronika" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5_T1m",1,"Energetyka",5,(SELECT ID FROM FIELD WHERE NAME = "Energetyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Mechaniczny")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("7I_IO1",1,"Informatyka - Inżynieria oprogramowania D30",7,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("7I_IO2",1,"Informatyka - Inżynieria oprogramowania D30",7,(SELECT ID FROM FIELD WHERE NAME = "Informatyka" AND DEPARTMENT_ID = (SELECT ID FROM DEPARTMENT WHERE NAME = "Wydzial Elektrotechniki, Elektroniki, Informatyki i Automatyki")));
...
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1AiR.",1,"Automatyka i robotyka",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1EiT.",1,"Elektronika i telekomunikacja",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1ET.",1,"Elektrotechnika",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1I.",1,"Informatyka",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1IB",1,"Inzynieria biomedyczna",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1M",1,"Mechatronika",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1S",1,"Systemy sterowania inteligentnymi budynkami",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1_E",1,"Energetyka",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("1_T",1,"Transport",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("2I",2,"Informatyka",1, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3AiR.",1,"Automatyka i robotyka",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3EiT.",1,"Elektronika i telekomunikacja",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3I.",1,"Informatyka",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3_IBP",1,"Inzynieria bezpieczenstwa pracy",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3M",1,"Mechatronika",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3S",1,"Systemy sterowania inteligentnymi budynkami",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("3_E.",1,"Energetyka",3, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5Air.",1,"Automatyka i robotyka",5, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5M",1,"Mechatronika",5, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5_E",1,"Energetyka",5, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5ET",1,"Elektrotechnika",5, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("5I",1,"Informatyka",5, 999999);
INSERT INTO DEAN_GROUP(ABBREVIATION,DEGREE,NAME,TERM,FIELD_ID) VALUES("7AiR",1,"Automatyka i robotyka",7, 999999);

#GRUPY RELACJE POMIEDZY WSPOLNA GRUPA A PODGRUPAMI

INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR1" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR2" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR3" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR4" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR5" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR6" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR7" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR8" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR9" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1AiR."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT1" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT2" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT3" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT4" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT5" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT6" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT7" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT8" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1EiT."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET1" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET2" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET3" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET4" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET5" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET6" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1ET."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I01" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I02" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I03" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I04" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I05" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I06" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I07" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I08" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I09" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I10" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I11" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I12" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I13" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I14" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I15" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I16" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1I."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB 1" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB 2" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB 3" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB 4" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB 5" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1IB"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M1" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M2" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M3" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M4" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M5" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M6" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1M"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S1" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S2" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S3" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S4" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1S"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E.1m" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E.2m" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E1e" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E2e" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_E"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_T1e" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_T"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_T.1m" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_T"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_T.2m" AND TERM = 1), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "1_T"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I CS" AND TERM = 2), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I ISBD" AND TERM = 2), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I SRiPM" AND TERM = 2), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I SAdPJEE" AND TERM = 2), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "2I"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR1" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR3" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR4" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR5" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR6" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3AiR."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT1" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT3" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT4" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT5" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3EiT."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I1" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I3" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I4" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I5" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I6" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I7" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I8" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I9" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3I."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_IBP W2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_IBP"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M1" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M3" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M4" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M5" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3M"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3S1" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3S"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3S2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3S"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E1e" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E2e" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E.1m" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E.1m2" AND TERM = 3), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "3_E."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5AiR1" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5Air."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5AiR2" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5Air."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5AiR3" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5Air."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5AiR4" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5Air."));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5AiR5" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5Air."));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5ET AiM" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5ET"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5ET E" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5ET"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5ET PE" AND TERM = 5), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "5ET"));


INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR1" AND TERM = 7), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR2" AND TERM = 7), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR3" AND TERM = 7), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR"));
INSERT INTO DEAN_GROUPS_RELATION(DEPENDENT_GROUP_ID, COMMON_GROUP_ID) VALUES((SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR4" AND TERM = 7), (SELECT ID FROM DEAN_GROUP WHERE ABBREVIATION = "7AiR"));
...
#############################################################################################
#TO SA TESTOWE DANE DODANE NA POTRZEBY DODANIA LOGIKI WSPOLNYCH PRZEDMIOTOW TYMCZASOWO !!! TRZEBA TO POTEM ZMIENIC
INSERT INTO DEPARTMENT (`ID`,`NAME`) VALUES (999999, "COMMON_HELPER_DEPARTMENT");
INSERT INTO FIELD(`ID`,`NAME`,`DEPARTMENT_ID`) VALUES (999999,"COMMON_HELPER_FIELD",999999);
#############################################################################################
