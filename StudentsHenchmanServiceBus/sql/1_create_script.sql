...
CREATE TABLE `DEAN_GROUPS_RELATION` (
  `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `COMMON_GROUP_ID` bigint(20) UNSIGNED NOT NULL,
  `DEPENDENT_GROUP_ID` bigint(20) UNSIGNED NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `FKb41jd92nrxigjt9wdrm8gyem2` (`COMMON_GROUP_ID`),
  KEY `FKabs702l4wsp4997tuq504wvbv` (`DEPENDENT_GROUP_ID`),
  CONSTRAINT `FKabs702l4wsp4997tuq504wvbv` FOREIGN KEY (`DEPENDENT_GROUP_ID`) REFERENCES `DEAN_GROUP` (`ID`),
  CONSTRAINT `FKb41jd92nrxigjt9wdrm8gyem2` FOREIGN KEY (`COMMON_GROUP_ID`) REFERENCES `DEAN_GROUP` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
